...
/***/ (function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	  ...
	  var dc = surveyEvents.dynamicContent;
	  // console.log(dc)
	  if (dc[0] === 'respondents' && dc[1] !== undefined) {
	    // Check if the URL parameter is bananas
	    $('#respondents').show();
	    api.getOneDynamicSurvey(dc[1]).then(ui.getOneDynamicSurveySuccess).catch(ui.getOneDynamicSurveyFailure);
	...
	$(document).ready(function () {
	  ...
	  var $input = $('#responseq1');
	  var $button = $('#res-string-create_response');
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://survey-team-project.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var resetPwValidation = function resetPwValidation() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateSurvey = function onCreateSurvey(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createSurvey(data).then(function (data) {
	...
	var onUpdateSurvey = function onUpdateSurvey(event) {
	  ...
	  api.updateSurvey(data).then(function (data) {
	...
	var populateUpdateForm = function populateUpdateForm(id) {
	...
	var findSurveyById = function findSurveyById(idToCompare) {
	  var result = void 0;
	  var i = void 0;
	  for (i in store.surveys) {
	    var id = store.surveys[i].id;
	    if (id === idToCompare) {
	...
	var onShowUpdateSurvey = function onShowUpdateSurvey() {
	  $('#updateSurvey').modal('show');
	};

	var onGetSurveys = function onGetSurveys(event) {
	  api.getSurveys().then(ui.getSurveysSuccess).catch(ui.getSurveysFailure);
	};
	...
	function getParameterByName() {
	  ...
	  if (window.location.href.split('?')[1] === undefined) {
	    ...
	    var arr = $.map(window.location.href.split('?')[1].split('&'), function (e, i) {
	      return e.split('=')[1];
	    });
	...
	var deleteItem = function deleteItem() {
	  ...
	  api.deleteSurvey(id).done(ui.deleteSurveySuccess).fail(ui.deleteSurveyFailure);
	  onGetSurveys();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getDynamicSurveys = function getDynamicSurveys() {
	  return $.ajax({
	    url: config.apiOrigin + '/surveys',
	    method: 'GET' // ,
	    // headers: {
	...
	var getOneDynamicSurvey = function getOneDynamicSurvey(surveyId) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  // getResponses,
	  getDynamicSurveys: getDynamicSurveys,
	  getOneDynamicSurvey: getOneDynamicSurvey
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showSurveysTemplate = __webpack_require__(15);
	var api = __webpack_require__(13);

	var getSurveys = function getSurveys(event) {
	  api.getSurveys().then(getSurveysSuccess).catch(getSurveysFailure);
	};

	var clearSurveyModal = function clearSurveyModal() {
	  $('#title').val('');
	};
	...
	var getDynamicSurveysSuccess = function getDynamicSurveysSuccess(data) {
	  // store.user = data.user
	  // console.log(data)
	...
	var getDynamicSurveysFailure = function getDynamicSurveysFailure(error) {
	  console.error(error);
	};

	var getOneDynamicSurveySuccess = function getOneDynamicSurveySuccess(data) {
	  // store.user = data.user
	  // console.log(data)
	...
	var getOneDynamicSurveyFailure = function getOneDynamicSurveyFailure(error) {
	  console.error(error);
	};
	...
	var deleteSurveyFailure = function deleteSurveyFailure(error) {
	  // console.log('deleteSurveyFailure, error = ', error)
	  console.error(error);
	};

	module.exports = {
	  clearSurveyModal: clearSurveyModal,
	  ...
	  getDynamicSurveysSuccess: getDynamicSurveysSuccess,
	  getDynamicSurveysFailure: getDynamicSurveysFailure,
	  getOneDynamicSurveySuccess: getOneDynamicSurveySuccess,
	  getOneDynamicSurveyFailure: getOneDynamicSurveyFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "        <tr data-id=\""
	    ...
	    + "</td>\n          <td>https://kqngo.github.io/survey-client/?dc1=respondents&dc2="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</td>\n          <td class=\"hideMe\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1), depth0))
	    + "</td>\n          <!-- <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.question1 : stack1), depth0))
	    + "</td> -->\n          <td class=\"glyphicon\"><button type=\"button\" class=\"remove-survey btn btn-default glyphicon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></button></td>\n          <td class=\"glyphicon\"><button type=\"button\" class=\"update-survey btn btn-default glyphicon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span></button></td>\n          <td class=\"glyphicon\"><button type=\"button\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"dashboard-button see-response btn btn-default glyphicon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-eye-open\" aria-hidden=\"true\"></span></button></td>\n\n      </tr>\n    </tbody>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table class=\"table\" id=\"survey-list-table\">\n  <BR />\n  <col style=\"width:20%\">\n  <col style=\"width:20%\">\n  <col style=\"width:40%\">\n  <thead>\n    <tr>\n      <th>Title</th>\n      <th>Question</th>\n      <th>Survey URL</th>\n      <!-- <th>Owner</th> -->\n    </tr>\n  </thead>\n\n    <tbody>\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateResponse = function onCreateResponse(event) {
	  ...
	  var textData = getFormFields(this).response.text;
	  // alert(textData)
	  var booleanData = getFormFields(this).response.boolean;
	  // alert(booleanData)
	  var ratingData = getFormFields(this).response.rating;
	  // alert(ratingData)
	  ...
	  api.createResponse(data).then(function (data) {
	    ui.createResponseSuccess(data);
	  }).catch(ui.createResponseFailure);
	};

	var onGetResponses = function onGetResponses(event) {
	  event.preventDefault();
	  var string = {};
	  ...
	  api.getResponses(string).then(function (data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getResponses = function getResponses(data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showResponsesTemplate = __webpack_require__(38);

	var createResponseSuccess = function createResponseSuccess(data) {
	  // console.log('createResponseSuccess')
	  $('#response-list-table').hide();
	  $('#default-display-text').text('Thanks for taking the survey! ¯\\_(ツ)_/¯');
	};

	var createResponseFailure = function createResponseFailure() {
	  // console.error(error)
	};

	var getResponsesSuccess = function getResponsesSuccess(data) {
	  $('#responses-content').hide();
	  $('#responses-content-text').hide();
	  // console.log(data)
	  ...
	  if (data.responses[0] !== undefined) {
	    ...
	    var showResponsesHtml = showResponsesTemplate({ responses: data.responses });
	    ...
	    for (var _i = 0; _i < arrTextResponse.length; _i++) {
	      arrTextResponse[_i] = arrTextResponse[_i].toLowerCase();
	    }

	    // Create Object with values of array and number of repeats

	    var result = {};
	    for (var _i2 = 0; _i2 < arrTextResponse.length; _i2++) {
	      if (!result[arrTextResponse[_i2]]) result[arrTextResponse[_i2]] = 0;
	      ++result[arrTextResponse[_i2]];
	    }

	    // print out contents of Hash
	    var total = Number(data.responses.length);

	    for (var key in result) {
	      var textResponseNum = Number(result[key]);
	      var ratingAnswers4percent = textResponseNum / total * 100;
	      var ratingAnswers4Percent = parseFloat(ratingAnswers4percent).toFixed(2);
	    ...
	    var yesAnswers = 0;
	    var noAnswers = 0;
	    var ratingAnswers1 = 0;
	    var ratingAnswers2 = 0;
	    var ratingAnswers3 = 0;
	    var ratingAnswers4 = 0;
	    var ratingAnswers5 = 0;
	    var totalRatingCount = 0;

	    for (var _i3 = 0; _i3 < data.responses.length; _i3++) {
	      // Boolean Metric Logic
	      if (data.responses[_i3].boolean === true) {
	        yesAnswers++;
	        var _total = Number(data.responses.length);
	        var yesAnswersResponseNum = Number(yesAnswers);
	        var yesAnswerspercent = yesAnswersResponseNum / _total * 100;
	        var yesAnswersPercent = parseFloat(yesAnswerspercent).toFixed(2);
	        ...
	        // }
	      } else if (data.responses[_i3].boolean === false) {
	        noAnswers++;
	        var _total2 = Number(data.responses.length);
	        var noAnswersResponseNum = Number(noAnswers);
	        var noAnswerspercent = noAnswersResponseNum / _total2 * 100;
	        var noAnswersPercent = parseFloat(noAnswerspercent).toFixed(2);
	      ...
	      // Ratings Meric Logic
	      if (data.responses[_i3].rating) {
	        var _total3 = Number(data.responses.length);
	        if (data.responses[_i3].rating === 1) {
	          ratingAnswers1++;
	          var ratingAnswers1ResponseNum = Number(ratingAnswers1);
	          totalRatingCount = totalRatingCount + 1;
	          var ratingAnswers1percent = ratingAnswers1ResponseNum / _total3 * 100;
	          var ratingAnswers1Percent = parseFloat(ratingAnswers1percent).toFixed(2);

	          $('.numberResponseData1').html('<tr>' + '<th>' + 'One' + '</th> ' + '<th>' + ('' + ratingAnswers1) + '</th>' + '<th>' + ('' + ratingAnswers1Percent) + '%' + '</th>' + '</tr>');
	        } else if (data.responses[_i3].rating === 2) {
	          ratingAnswers2++;
	          var ratingAnswers2ResponseNum = Number(ratingAnswers2);
	          totalRatingCount = totalRatingCount + 2;
	          var ratingAnswers2percent = ratingAnswers2ResponseNum / _total3 * 100;
	          var ratingAnswers2Percent = parseFloat(ratingAnswers2percent).toFixed(2);

	          $('.numberResponseData2').html('<tr>' + '<th>' + 'Two' + '</th> ' + '<th>' + ('' + ratingAnswers2) + '</th>' + '<th>' + ('' + ratingAnswers2Percent) + '%' + '</th>' + '</tr>');
	        } else if (data.responses[_i3].rating === 3) {
	          ratingAnswers3++;
	          var ratingAnswers3ResponseNum = Number(ratingAnswers3);
	          totalRatingCount = totalRatingCount + 3;
	          var ratingAnswers3percent = ratingAnswers3ResponseNum / _total3 * 100;
	          var ratingAnswers3Percent = parseFloat(ratingAnswers3percent).toFixed(2);

	          $('.numberResponseData3').html('<tr>' + '<th>' + 'Three' + '</th> ' + '<th>' + ('' + ratingAnswers3) + '</th>' + '<th>' + ('' + ratingAnswers3Percent) + '%' + '</th>' + '</tr>');
	        } else if (data.responses[_i3].rating === 4) {
	          ratingAnswers4++;
	          var ratingAnswers4ResponseNum = Number(ratingAnswers4);
	          totalRatingCount = totalRatingCount + 4;
	          var _ratingAnswers4percent = ratingAnswers4ResponseNum / _total3 * 100;
	          var _ratingAnswers4Percent = parseFloat(_ratingAnswers4percent).toFixed(2);

	          $('.numberResponseData4').html('<tr>' + '<th>' + 'Four' + '</th> ' + '<th>' + ('' + ratingAnswers4) + '</th>' + '<th>' + ('' + _ratingAnswers4Percent) + '%' + '</th>' + '</tr>');
	        } else if (data.responses[_i3].rating === 5) {
	          ratingAnswers5++;
	          var ratingAnswers5ResponseNum = Number(ratingAnswers5);
	          totalRatingCount = totalRatingCount + 5;
	          var ratingAnswers5percent = ratingAnswers5ResponseNum / _total3 * 100;
	          var ratingAnswers5Percent = parseFloat(ratingAnswers5percent).toFixed(2);

	          $('.numberResponseData5').html('<tr>' + '<th>' + 'Five' + '</th> ' + '<th>' + ('' + ratingAnswers5) + '</th>' + '<th>' + ('' + ratingAnswers5Percent) + '%' + '</th>' + '</tr>');
	        }
	        var ratingaverage = totalRatingCount / _total3;
	        var ratingAverage = parseFloat(ratingaverage).toFixed(2);
	...
	var getResponsesFailure = function getResponsesFailure() {
	  // console.error(error)
	};

	module.exports = {
	  createResponseSuccess: createResponseSuccess,
	  createResponseFailure: createResponseFailure,
	  getResponsesSuccess: getResponsesSuccess,
	  getResponsesFailure: getResponsesFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "            <tr data-id=\""
	    ...
	    + "\">\n"
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.text : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.program(6, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	  ...
	  return "              <td>"
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1["boolean"] : stack1), depth0))
	    + "</td>\n";
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(data && data.last),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	    ...
	    return "                <h3> Total Number of Reponse: "
	    + container.escapeExpression(__default(__webpack_require__(39)).call(depth0 != null ? depth0 : (container.nullContext || {}),(data && data.index),{"name":"count","hash":{},"data":data}))
	    + "</h3>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

	  return "  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-xs-6\">\n        <table class=\"table table-sm\" id=\"response-list-table\">\n          <thead>\n            <tr>\n              <th>Raw Response Data</th>\n            </tr>\n          </thead>\n          <tbody>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.responses : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "            </tbody>\n          </table>\n        </div>\n        <div class=\"col-xs-6\">\n          <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.responses : depth0),{"name":"each","hash":{},"fn":container.program(8, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "              </div>\n              <div class=\"modal-body\">\n                <div>\n                  <div id=\"text-response-data\">\n                    <div id=\"boolean-response-data\">\n                      <div id=\"number-response-data\">\n                        <table class=\"table table-sm\" id=\"response-list-table\">\n                          <thead>\n                            <tr>\n                              <th>Response</th>\n                              <th># of Occurrences</th>\n                              <th>% of Occurrences</th>\n                            </tr>\n                          </thead class=\"numberResponseData\">\n                          <tbody class=\"textResponseInfo booleanResponseData1 numberResponseData1\"></tbody>\n                          <tbody class=\"booleanResponseData2 numberResponseData2\"></tbody>\n                          <tbody class=\"numberResponseData3\"></tbody>\n                          <tbody class=\"numberResponseData4\"></tbody>\n                          <tbody class=\"numberResponseData5\"></tbody>\n                        </table>\n                      </div>\n                    </div>\n                  </div>\n                  <div class=\"modal-header\">\n                    <div class=\"ratingAverage\"></div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/index.js!./tasks.scss", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/index.js!./tasks.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
